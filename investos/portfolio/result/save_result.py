...
class SaveResult():
    def save(self, description, tags, api_key, api_endpoint="https://app.forecastos.com/api/v1"):
    ...
    def save_backtest(self, description):
        ...
        if response.status_code // 100 == 2:  # Check if the status code is in the 200 range
            ...
            print(f"Backtest API request failed with status code: {response.status_code}")
